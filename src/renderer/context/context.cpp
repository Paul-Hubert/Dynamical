...
Context::Context(entt::registry& reg) : win(*this, reg), instance(*this, reg), device(*this, reg), transfer(*this, reg), compute(*this, reg), swap(*this, reg), classic_render(*this, reg) {
