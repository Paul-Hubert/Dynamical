...
entt::entity dy::buildPlant(entt::registry& reg, glm::vec2 position, glm::vec2 size, glm::vec4 color, int type) {
...
entt::entity dy::buildTree(entt::registry& reg, glm::vec2 position) {
    return dy::buildPlant(reg, position, glm::vec2(1,1), glm::vec4(0.03,0.47,0.19,1.0), Plant::tree);
}

entt::entity dy::buildBerryBush(entt::registry& reg, glm::vec2 position) {
    return dy::buildPlant(reg, position, glm::vec2(1,1), glm::vec4(0.60,0.0588,0.2941,1.0), Plant::berry_bush);
}
