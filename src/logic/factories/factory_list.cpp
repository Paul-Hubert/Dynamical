...
entt::entity dy::buildBerryBush(entt::registry& reg, glm::vec2 position) {
    auto entity = dy::buildPlant(reg, position, glm::vec2(1,1), Color(0.60,0.0588,0.2941,1.0), Plant::berry_bush);    
    return entity;
}

entt::entity dy::buildAnimal(entt::registry& reg, glm::vec2 position, Color color) {
    entt::entity entity = dy::buildObject(reg, position, glm::vec2(1,1), color);
...
entt::entity dy::buildBunny(entt::registry& reg, glm::vec2 position) {
    entt::entity entity = dy::buildAnimal(reg, position, Color(0.8431,0.8627,0.8667,1.0));
    return entity;
}

entt::entity dy::buildHuman(entt::registry& reg, glm::vec2 position, Color color) {
    entt::entity entity = dy::buildAnimal(reg, position, color);
